      ...
      <div className="bg-zinc-900 rounded-2xl border border-zinc-800 overflow-x-auto">
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id} className="border-b border-zinc-800/50 hover:bg-zinc-800/30 transition-colors">
                ...
                <td className="px-4 py-3">
                  <span className="text-brand-300 font-semibold text-sm">{formatBRL(product.price)}</span>
                </td>
        ...
        {products.length === 0 && (
          <div className="py-12 text-center text-zinc-500">
            ...
            <Link href="/admin/products/new" className="text-brand-300 text-sm hover:underline mt-1 block">
